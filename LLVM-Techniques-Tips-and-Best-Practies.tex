...
\begin{document}
	...
	\subsubsection*{\zihao{3} 10.3.\hspace{0.2cm}使用值和指令}
	\addcontentsline{toc}{subsubsection}{10.3.\hspace{0.2cm}使用值和指令}
	\subfile{content/3/chapter10/3.tex}
	
	\subsubsection*{\zihao{3} 10.4.\hspace{0.2cm}使用循环}
	\addcontentsline{toc}{subsubsection}{10.4.\hspace{0.2cm}使用循环}
